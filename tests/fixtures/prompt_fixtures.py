...
def make_valid_json_outputs() -> dict[str, str]:
    ...
    return {
        ...
        "main.npc_dialogue": '{"dialogue": "Welcome, travelers.", "action_beat": "The innkeeper nods.", "mood": "friendly"}',
        "main.combat_summary": '{"summary": "Steel clashes in the dark.", "outcomes": [], "tension": "high"}',
        "main.ruling_proposal": '{"ruling": "allow", "reason": "Action is valid."}',
